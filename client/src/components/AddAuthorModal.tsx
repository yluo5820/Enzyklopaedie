...
import { Author, NewAuthor, Subject, Nation } from '@enzyklopaedie/shared';
import { createAuthor, fetchSubjects, fetchNations, createSubject, createNation } from '../api';
...
const AddAuthorModal: React.FC<AddAuthorModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const addedAuthor = await createAuthor(newAuthor);
