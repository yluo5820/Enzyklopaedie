...
import { Nation, NewNation, Author, Civilization, Era } from '@enzyklopaedie/shared';
import { createNation, fetchAuthors, fetchCivilizations, fetchEras, createAuthor, createCivilization, createEra } from '../api';

interface AddNationModalProps {
  isOpen: boolean;
  onClose: () => void;
  onNationAdded: (nation: Nation) => void;
}

const AddNationModal: React.FC<AddNationModalProps> = ({
  isOpen,
  onClose,
  onNationAdded,
}) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const addedNation = await createNation(newNation);
      onNationAdded(addedNation);
      resetForm();
      onClose();
    } catch (error) {
