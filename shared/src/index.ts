...
export type CanonicalHistoricalEntityKind =
  | 'person'
  | 'ruler'
  | 'battle'
  | 'nation'
...
export type UpdateWorldHistoryPolity = Partial<
  Omit<WorldHistoryPolity, 'id' | 'createdAt' | 'updatedAt'>
>;
export type NewWorldHistoryPolitySnapshot = Omit<
  WorldHistoryPolitySnapshot,
  'id' | 'createdAt' | 'updatedAt'
>;
export type UpdateWorldHistoryPolitySnapshot = Partial<
  Omit<WorldHistoryPolitySnapshot, 'id' | 'createdAt' | 'updatedAt'>
>;
...
export type NewCanonicalHistoricalEntity = Omit<
  ...
  'id' | 'createdAt' | 'updatedAt'
>;
export type UpdateCanonicalHistoricalEntity = Partial<
  Omit<CanonicalHistoricalEntity, 'id' | 'createdAt' | 'updatedAt'>
>;
